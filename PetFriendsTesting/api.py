...
#НЕДОСТАЮЩИЕ МЕТОДЫ
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """Метод создает питомца без фото и возвращает статус запроса и результат в формате JSON"""
    ...
    def set_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фото к существующему питомцу и возвращает статус запроса и результат"""
